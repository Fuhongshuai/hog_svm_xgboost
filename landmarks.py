...
np.save(current_dir + '/labels' + '.npy',labels_list)
np.save(current_dir + '/hog' + '.npy',hog_features)
np.save(current_dir + '/landmarks' + '.npy',landmarks)
